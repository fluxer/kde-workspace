...
{
    // About data
    KAboutData aboutData("systemsettings", 0, ki18n("System Settings"), KDE_VERSION_STRING, ki18n("Central configuration center for Sangria."), KAboutData::License_GPL, ki18n("(c) 2009, Ben Cooksley"));
