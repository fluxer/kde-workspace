...
protected:
     ...
     * @param meta - Basically a wildcard to carry various extra information, eg. the anchor, relativity or rotation axis. You will probably use it when performing Generic animations.
