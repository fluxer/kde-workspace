 ...
 * @see KItemModelBase
 */
class DOLPHINPRIVATE_EXPORT KItemListView : public QGraphicsWidget
{
    Q_OBJECT
 ...
 * @internal
 */
class DOLPHINPRIVATE_EXPORT KItemListCreatorBase
{
public:
 ...
 * instances.
 */
class DOLPHINPRIVATE_EXPORT KItemListWidgetCreatorBase : public KItemListCreatorBase
{
public:
 ...
 */
class DOLPHINPRIVATE_EXPORT KItemListGroupHeaderCreatorBase : public KItemListCreatorBase
{
public:
