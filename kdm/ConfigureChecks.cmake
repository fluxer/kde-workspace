...
if (NOT "${KDE4_LIBEXEC_INSTALL_DIR}" STREQUAL "${KDE4_BIN_INSTALL_DIR}")
    STRING(LENGTH "${KDE4_BIN_INSTALL_DIR}" bidl)
    STRING(LENGTH "${KDE4_LIBEXEC_INSTALL_DIR}" lxidl)
    ...
    if (bidl LESS ${ipsl} OR lxidl LESS ${ipsl})
        ...
        STRING(SUBSTRING "${KDE4_BIN_INSTALL_DIR}" 0 ${ipsl} bpr)
        STRING(SUBSTRING "${KDE4_LIBEXEC_INSTALL_DIR}" 0 ${ipsl} lpr)
    ...
    if (NOT inip)
        ...
        STRING(SUBSTRING "${KDE4_BIN_INSTALL_DIR}" ${ipsl} ${bsfxl} bsfx)
        STRING(REPLACE "/" ";" bsfxl "${bsfx}")
        LIST(LENGTH bsfxl KDM_LIBEXEC_STRIP)
        MATH(EXPR klxsfxl "${lxidl} - ${ipsl}")
        STRING(SUBSTRING "${KDE4_LIBEXEC_INSTALL_DIR}" ${ipsl} ${klxsfxl} KDM_LIBEXEC_SUFFIX)
    endif (NOT inip)
endif (NOT "${KDE4_LIBEXEC_INSTALL_DIR}" STREQUAL "${KDE4_BIN_INSTALL_DIR}")
